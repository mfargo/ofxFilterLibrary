...
AdditiveBlendFilter::AdditiveBlendFilter() : AbstractTwoInputFilter() {
    _setupShader();
}
AdditiveBlendFilter::~AdditiveBlendFilter() {}

string AdditiveBlendFilter::_getFragSrc() {
